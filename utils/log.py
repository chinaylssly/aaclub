...
class Log(object):
    ...
    def __init__(self,log_folder=LOG_FOLDER,filename=None,name=__name__,level='DEBUG',mode=MODE,log_to_console=LOG_TO_CONSOLE,log_to_file=LOG_TO_FILE):
